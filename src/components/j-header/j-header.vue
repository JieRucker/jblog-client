...
<template>
  <header id="header" class="header" v-if="showHeader">
    ...
    <div class="brand" :style="brandStyles" v-if="displayBrand">
      <div class="title">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      ...mapGetters({
          get_person_info: 'app/get_person_info',
      }),
      brandStyles() {
        return {
    ...
    methods: {
      ...mapMutations({
        setHandleSearch: 'app/SET_HANDLE_SEARCH'
      }),
      init() {
      ...
      listenScroll() {
        ...
        this.headerMask = isPc ? this.getScrollTop() > 550 : this.getScrollTop() > 100;
      },
      getScrollTop() {
        let scrollTop = 0;
        ...
        return () => {
          const loop = () => {
            ...
            const canvas = document.querySelector("#wave"),
              ...
              offset = this.$Global.isPc() ? [15, 10] : [10, 5],  // 波浪偏移距离
