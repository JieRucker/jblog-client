...
const webpackConfig = merge(baseWebpackConfig, {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            title: 'JRucker博客',
            keywords: 'JRucker,blog',
            family: '//fonts.loli.net/css?family=Sigmar One:300,300italic,400,400italic,700,700italic&subset=latin,latin-ext',
            iconfont: '//at.alicdn.com/t/font_733969_icvberhy4fj.css?v=' + new Date().getTime(),
            ico: '//jrucker.cn/images/favicon.ico',
            appleTouchIcon: '//jrucker.cn/images/DIYgod-180x180.jpg?v=0.0.2',
